...
<form class="d-flex" action="crud_estudiantes.php" method="post">
    ...
    <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="txt" name="txt_carne" id="txt_carne" class="form-control" placeholder="Carne: 01" required>          
        </div>
        <div class="mb-3">
            <label for="lbl_nombres" class="form-label"><b>Nombres</b></label>
            <input type="txt" name="txt_nombres" id="txt_nombres" class="form-control" placeholder="Nombres: Nombre1 Nombre2" required>            
        </div>
        <div class="mb-3">
            <label for="lbl_apeillidos" class="form-label"><b>Apellidos</b></label>
            <input type="txt" name="txt_apeillidos" id="txt_apeillidos" class="form-control" placeholder="Apellidos: Apellido1 Apellido2" required>            
        </div>
        <div class="mb-3">
            <label for="lbl_direccion" class="form-label"><b>Direccion</b></label>
            <input type="txt" name="txt_direccion" id="txt_direccion" class="form-control" placeholder="Direccion: #casa calle avenida lugar " required>            
        </div>
        <div class="mb-3">
...
<table class="table table-striped table-inverse table-responsive">
    <thead class="thead-inverse">
      ...
      <tbody id="tbl_estudiantes" >  
            ...
            include("datos_conexion.php");
            $db_conexion = mysqli_connect($db_host,$db_usr,$db_pass,$db_nombre);
            $db_conexion ->real_query("select e.id_estudiantes as id,e.carne,e.nombres,e.apeillidos,e.direccion,e.telefono,e.correo_electronico,t.sangre,e.fecha_nacimiento,e.id_tipo_sangre FROM estudiantes as e inner join tipos_sangre as t on e.id_tipo_sangre = t.id_tipo_sangre;");
            $resultado = $db_conexion->use_result();
            while($fila = $resultado->fetch_assoc()){
